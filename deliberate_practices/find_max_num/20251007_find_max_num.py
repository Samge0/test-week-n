...
# 模型路径
MODEL_PATH = os.path.join(CURRENT_DIR, 'models_output/model_20251007.pth')
...
def train():
    ...
    for epoch in range(epochs):
        ...
        indeices = torch.randperm(batch_total)
        ...
        print(f"epoch: [{epoch+1}/{epochs}], acc: {acc}, mean_loss: {mean_loss}")
